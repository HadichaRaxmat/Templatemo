...
from .views import (home_view, meetings_view, meeting_details_view, header_create, header_update, header_list,
                    ...
                    banner_update, banner_delete, carousel_create, login_view, signup_view, carousel_list, carousel_update,
                    carousel_delete, meeting_create, meeting_list, meeting_update, meeting_delete, meeting_header_create,
                    meeting_header_delete, meeting_header_list, meeting_header_update, user_update, user_delete,
                    users_list, logout_view, middle_create, middle_delete, middle_list, middle_update, popular_delete,
                    ...
                    about_list, about_delete, about_create, contact_create, contact_delete, contact_update, contact_view,
                    contact_list, contact_list_view, user_contact_update, user_contact_delete, HeaderListAPIView,
                    HeaderDetailAPIView, admin_logout, ContactListAPIView, ContactDetailAPIView, BannerListAPIView,
                    BannerDetailAPIView, CarouselListAPIView, CarouselDetailAPIView, MeetingListAPIView, MeetingDetailAPIView,
                    admin_create, MiddleListAPIView, MiddleDetailAPIView, AboutDetailAPIView, AboutListAPIView, PopularListAPIView,
